...
class DefaultTrainer(TrainerBase):
    ...
    def __init__(self, cfg):
        ...
        """
        super().__init__()
        logger = logging.getLogger("CrossModalGraph")
        ...
        if cfg.WANDB.ENABLED:
            init_wab(
                wab_config_path=cfg.WANDB.CONFIG_PATH,
        ...
        if comm.is_main_process():
            ...
            ret.append(
                hooks.PeriodicWriter(
                    self.build_writers(), period=cfg.TRAINING.TRAIN_PLOT_PERIOD
                )
            )
        return ret
    ...
    def build_writers(self):
        ...
        return default_writers(
            self.cfg.OUTPUT_DIR, self.max_iter, self.cfg.TRAINING.TRAIN_PLOT_PERIOD
        )
...
def default_writers(
    output_dir: str, max_iter: Optional[int] = None, window_size: int = 20
):
    """
    ...
    return [
        ...
        CommonMetricPrinter(max_iter, window_size=window_size),
