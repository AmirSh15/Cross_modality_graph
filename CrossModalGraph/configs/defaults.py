from CrossModalGraph.configs.config import CfgNode as CN
...
# -----------------------------------------------------------------------------
# Weight and bias options
# -----------------------------------------------------------------------------
_C.WANDB = CN()
_C.WANDB.ENTITY = ""
_C.WANDB.PROJECT_NAME = "CrossModalGraph"
_C.WANDB.GP_NAME = ""
_C.WANDB.EXP_NAME = ""
_C.WANDB.KEY = ""
_C.WANDB.CONFIG_PATH = ""
...
# -----------------------------------------------------------------------------
_C.AUDIO_MODEL = CN()
_C.AUDIO_MODEL.NAME = "WAV2VEC2_BASE"  # "WAV2VEC2_LARGE_LV60K" or "WAV2VEC2_LARGE"
_C.AUDIO_MODEL.FINETUNE = True

# -----------------------------------------------------------------------------
# Video model options
# -----------------------------------------------------------------------------
_C.VIDEO_MODEL = CN()
_C.VIDEO_MODEL.NAME = "r3d_18"
_C.VIDEO_MODEL.FINETUNE = True
...
_C.MODEL.AUDIO_BACKBONE.NAME = (
    "WAV2VEC2_BASE"  # "WAV2VEC2_LARGE_LV60K" or "WAV2VEC2_LARGE"
)
_C.MODEL.AUDIO_BACKBONE.PRETRAINED_ON = "Vggish"
_C.MODEL.AUDIO_BACKBONE.FINETUNE = True

_C.MODEL.VIDEO_BACKBONE = CN()

_C.MODEL.VIDEO_BACKBONE.NAME = "r3d_18"
...
# Add audio and video segment length (in msec)
_C.GRAPH.AUDIO_SEGMENT_LENGTH = 960
_C.GRAPH.VIDEO_SEGMENT_LENGTH = 250
...
# Enable accumulation of gradients (to enable use an integer value > 1)
