...
def pairwise_distances(x, y=None, type="euclidean", eps=1e-8):
    """
    Input: x is a Nxd matrix
           y is an optional Mxd matirx
           type is the type of distance, e.g. euclidean, cosine, etc.
           eps is a small number to prevent nan
    ...
    if type == "cosine":
        ...
        w2 = w1 if y is x else y.norm(p=2, dim=1, keepdim=True)
        return 1 - torch.mm(x, y.t()) / (w1 * w2.t()).clamp(min=eps)
    elif type == "euclidean":
